...
class BRICS_Connection(Connection) :
    def __init__(self, unit1: Unit, unit2: Unit, atom_index1: int, atom_index2: int, \
                       brics_label1: Union[str, int], brics_label2: Union[str, int], \
                    bond_index: int, bondtype: BondType) :
...
class BRICS_FragmentedGraph(FragmentedGraph) :
    def fragmentation(self, mol: Mol) -> Tuple[List[Unit], List[Connection]] :
        ...
        for brics_bond in brics_bonds :
            ...
            connection = BRICS_Connection(unit1, unit2, atom_index1, atom_index2, brics_label1, brics_label2, bond_index, bondtype)
